...
export function createChannelMonitorSettingsUpdatePayload(
  ...
  if (mode === 'schedule') {
    return {
      ...
      smart_schedule_realtime_sample_limit:
        values.smartScheduleRealtimeSampleLimit,
  ...
  return {
    ...
    channel_concurrency_wait_seconds: values.channelConcurrencyWaitSeconds,
    ...
    ratio_monitor_task_retention_days: values.ratioMonitorTaskRetentionDays,
    smart_schedule_task_retention_days: values.smartScheduleTaskRetentionDays,
    smart_schedule_probe_task_retention_days:
      values.smartScheduleProbeTaskRetentionDays,
    cleanup_task_retention_days: values.cleanupTaskRetentionDays,
    model_detection_task_retention_days: values.modelDetectionTaskRetentionDays,
    channel_test_task_retention_days: values.channelTestTaskRetentionDays,
    model_update_task_retention_days: values.modelUpdateTaskRetentionDays,
    ...
    group_monitor_retention_days: values.groupMonitorRetentionDays,
    model_detection_retention_days: values.modelDetectionRetentionDays,
    cleanup_enabled: values.cleanupEnabled,
    cleanup_batch_size: values.cleanupBatchSize,
    cleanup_budget_seconds: values.cleanupBudgetSeconds,
    cleanup_continuation_seconds: values.cleanupContinuationSeconds,
    cleanup_interval_minutes: values.cleanupIntervalMinutes,
    ...
    error_message_whitelist: values.errorMessageWhitelist,
