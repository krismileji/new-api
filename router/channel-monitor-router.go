...
func registerChannelMonitorRoutes(apiRouter *gin.RouterGroup) {
	...
	)
	{
		...
		monitorRoute.DELETE("/upstream_accounts/:id", controller.DeleteChannelMonitorUpstreamAccount)
		...
		monitorRoute.POST("/automations/:id/run", controller.RunUpstreamAutomationNow)
		monitorRoute.POST("/automations/:id/actions/:action_id/acknowledge", controller.AcknowledgeUpstreamAutomationAction)
		monitorRoute.POST("/automations/:id/actions/:action_id/reset-count", controller.ResetUpstreamAutomationAttempts)
		...
		monitorRoute.GET("/passive", controller.GetChannelPassiveMonitor)
		monitorRoute.GET("/passive/:target/history", controller.GetChannelPassiveMonitorHistory)
		monitorRoute.GET("/passive/:target/versions", controller.GetChannelPassiveMonitorVersions)
		...
		monitorRoute.GET("/channel/:id/probe-policy", controller.GetChannelMonitorProbePolicy)
		monitorRoute.PUT("/channel/:id/probe-policy", controller.UpdateChannelMonitorProbePolicy)
