...
func calculateTextQuotaSummaryWithQuotaPerUnit(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, usage *dto.Usage, quotaPerUnit float64) textQuotaSummary {
	...
	if !summary.hasBillableUsage() && !relayInfo.PriceData.UsePrice {
		summary.Quota = 0
...
func PostTextConsumeQuota(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, usage *dto.Usage, extraContent []string) {
	...
	recordTextChannelDailyCost(ctx, relayInfo, billingUsage, originUsage, summary, tieredBillingApplied, tieredResult)
