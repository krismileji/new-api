...
func TestGetChannelMonitorCostOverviewReadsSettledDailyFacts(t *testing.T) {
	...
	assert.Equal(t, int64(2), overview.Items[0].SettledCount)
	assert.Equal(t, int64(2), overview.Items[1].SettledCount)
	...
	assert.Equal(t, int64(4), overview.Coverage.SettledCount)
