...
func RecordChannelRatioMonitorBalance(channelId int, balance *float64, fetchError string) error {
	_, err := recordChannelRatioMonitorBalance(context.Background(), channelId, balance, fetchError, nil)
	return err
}
...
func RecordChannelRatioMonitorBalanceIfRevision(ctx context.Context, channelId int, expectedRevision int64, balance *float64, fetchError string) (bool, error) {
	return recordChannelRatioMonitorBalance(ctx, channelId, balance, fetchError, &expectedRevision)
}
