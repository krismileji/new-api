...
func TestVerify02SQLiteColdStartCreatesFinalChannelMonitorSchema(t *testing.T) {
	...
	finalTables := []string{
		...
		"channel_monitor_daily_success_metrics",
		"channel_monitor_daily_success_minutes",
		"channel_monitor_daily_cost_details",
		"channel_monitor_cost_backfill_checkpoints",
		"channel_monitor_cost_reconciliations",
	...
	indexes := []struct {
		...
		{&ChannelMonitorMinuteRouteMetric{}, "idx_cm_route_model_window"},
		...
		{&ChannelMonitorMinuteAPIKeyMetric{}, "idx_cm_api_model_window"},
