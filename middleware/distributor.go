...
func Distribute() func(c *gin.Context) {
	return func(c *gin.Context) {
			...
			if shouldSelectChannel {
				...
				if strings.HasPrefix(c.Request.URL.Path, "/pg/chat/completions") {
					...
					if playgroundRequest.Group != "" {
						...
						if !service.GroupInRoleUsableGroups(userGroup, c.GetInt("role"), playgroundRequest.Group) && playgroundRequest.Group != usingGroup {
		...
		if channel != nil {
			allowAlternative := !channelPinned && shouldSelectChannel
