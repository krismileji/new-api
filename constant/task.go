...
const (
	...
	// Deprecated aliases retained for downstream callers that still reference
	// the pre-plugin action vocabulary. NormalizeTaskAction converts these
	// persisted values to the canonical names above.
